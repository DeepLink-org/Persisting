...
impl From<CaptureRecord> for persisting_pchronicle::EventRecord {
    fn from(r: CaptureRecord) -> Self {
        Self {
            seq: r.seq,
            source: r.source,
            kind: r.kind,
...
impl From<persisting_pchronicle::EventRecord> for CaptureRecord {
    fn from(r: persisting_pchronicle::EventRecord) -> Self {
        Self {
            seq: r.seq,
            source: r.source,
            kind: r.kind,
