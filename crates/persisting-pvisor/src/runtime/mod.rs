...
pub use overlay::{
    ...
    mount_overlay_record_read_only, overlay_changes, overlay_status, restore_overlay_upper,
    snapshot_overlay_upper, write_overlay_record, ChangeEntry, ChangeEntryType, ChangeKind,
    OverlayRecord, OverlayState, OverlayUpper, ReadOnlyOverlayMount,
};
pub use registry::{
