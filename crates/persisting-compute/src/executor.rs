//! L3 Executor seam — Worker invokes this; L2 Driver only schedules TaskExpr.
//!
...
#[async_trait]
impl Executor for PlanExecuteExecutor {
    fn name(&self) -> &str {
        "execute"
    }
...
impl ExecutorRouter {
    ...
    pub async fn run(&self, task: TaskExpr, worker_id: &str) -> TaskResult {
        self.run_with_cancel(task, worker_id, CancellationToken::new())
            .await
    }
