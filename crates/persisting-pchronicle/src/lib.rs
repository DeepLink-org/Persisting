...
pub use store::{
    ...
    ChronicleQueryEngine, ChronicleQueryExecutionOptions, CommitRunOutcome, DatasetCatalogSnapshot,
    DatasetMount, DiscoveredSource, EventFactSnapshot, EventLogLayoutStats, EventRow,
    ...
    LocalQueryManifestOptions, NamespacePath, ProjectionSourceSnapshot, QueryBackendInfo,
    QuerySnapshot, RawEventDataSource, RawEventDataSourceOptions, RawEventLanceAppender,
    ...
    StorylineTableKind, StorylineTablePaths, StorylineTableProvider, TrajectoryStats,
