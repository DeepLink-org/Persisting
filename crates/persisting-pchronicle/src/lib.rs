...
pub use store::{
    ...
    ExportOutcome, LanceEventStore, LanceStorylineStore, LeaseAcquireOutcome, MemoryChronicleStore,
    NormalizedStore, ReplayOutcome, RunControlStore, StorageKind, StorylineDataFusionTableNames,
    StorylineDataSource, StorylineDataSourceOptions, StorylineTableKind, StorylineTablePaths,
    StorylineTableProvider, StructuredStore, TrajectorySession, TrajectoryStats,
