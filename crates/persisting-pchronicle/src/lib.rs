...
pub use store::{
    ...
    CatalogSourceStatus, CatalogStorylineKey, CatalogTrajectoryBundle, ChronicleQueryEngine,
    ...
    NamespacePath, ProjectionSourceSnapshot, QueryBackendInfo, QuerySnapshot, RawEventDataSource,
