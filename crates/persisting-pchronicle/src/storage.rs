...
pub use crate::store::{
    ...
    ManifestCache, ManifestKind, ManifestListing, ManifestReadMode, ManifestStats, NamespacePath,
    PathListEntry, PathListKind, PersistentCache, PhysicalColumn, PhysicalDataFile,
    PhysicalFileLayout, PhysicalFragment, PhysicalLayout, PhysicalPage, PhysicalPagePreview,
    PhysicalPageQuery, PhysicalSource, PhysicalTable, ProjectionSourceSnapshot, QueryScope,
    RawEventLanceAppender, RawEventLanceStore, ReplayOutcome, ResolveMode, ResolveTarget,
