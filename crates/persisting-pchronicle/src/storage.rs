...
pub use crate::store::{
    ...
    ManifestReadMode, ManifestStats, NamespacePath, ObjectStoreManifestWriteMode, PathListEntry,
    PathListKind, PersistentCache, PhysicalColumn, PhysicalDataFile, PhysicalFileLayout,
    PhysicalFragment, PhysicalLayout, PhysicalPage, PhysicalPagePreview, PhysicalPageQuery,
    PhysicalSource, PhysicalTable, ProjectionSourceSnapshot, QueryScope, RawEventLanceAppender,
    RawEventLanceStore, ReplayOutcome, ResolveMode, ResolveTarget, RunControlStore,
    ShallowNavEntry, StorylineContentOptions, StorylineContentReadMode, StorylineDataSource,
    StorylineDataSourceOptions, StorylineLanceStore, StorylineMaintenanceReport,
    StorylineProjectionLineage, StorylineSearchIndexSuppressGuard, StorylineStreamImportReport,
