...
pub use crate::store::{
    ...
    CommitRunOutcome, CompactJsonlColumn, CompactJsonlOffload, CompactJsonlOptions,
    ...
    LanceMaintenanceReport, LeaseAcquireOutcome, NamespacePath, ObjectStoreManifestWriteMode,
