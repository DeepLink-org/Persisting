...
pub use crate::store::{
    ...
    EventLogLayoutStats, EventWriterFence, ExportOutcome, ImportableObjectEvent,
    LanceMaintenanceOptions, LanceMaintenanceReport, LeaseAcquireOutcome, ManifestKind,
    ManifestStats, NamespacePath, ObjectStoreManifestWriteMode, PhysicalColumn, PhysicalDataFile,
    ...
    RawEventLanceAppender, RawEventLanceStore, ReplayOutcome, RunControlStore, ShallowNavEntry,
    ...
    StorylineProjectionLineage, StorylineStreamImportReport, StorylineStreamOptions,
