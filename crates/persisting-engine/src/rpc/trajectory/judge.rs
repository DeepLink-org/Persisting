//! RPC adapter for pChronicle-owned trajectory judgment.

use anyhow::Result;
use persisting_pchronicle::{
    judge_trajectory, JudgeTrajectoryRequest, JudgingMethod, JudgmentScope, ManualJudgmentInput,
};
use persisting_proto::{JudgeMethod, JudgeScope, TrajectoryJudgeRequest, TrajectoryJudgeResponse};
