...
Latest nightly pChronicle benchmark: `5a1ed35ab09d` on `linux/x86_64` (2026-09-12T13:27:56.688833+00:00).

| Case | Metric | Value |
|---|---:|---:|
| `criterion/atif_conversion/parse_corpus` | `latency_median_ns` | 5.223e+06 ns |
| `criterion/atif_conversion/roundtrip_corpus` | `latency_median_ns` | 7.126e+06 ns |
| `criterion/projection_cpu/events_to_storyline_corpus` | `latency_median_ns` | 3.329e+05 ns |
| `system/projection_pipeline/event_append` | `initial_append_ms` | 68.244 ms |
| `system/projection_pipeline/projection_build` | `build_ms` | 5248.395 ms |
| `system/projection_pipeline/projection_incremental` | `sync_ms` | 42.257 ms |
| `system/lance_vs_json/lifecycle` | `cold_query_ms` | 3033.523 ms |
| `system/lance_vs_json/lifecycle` | `get_storyline_full_ms` | 10.14 ms |
| `system/lance_vs_json/lifecycle` | `replace_storyline_ms` | 46.689 ms |
| `system/lance_vs_json/selective` | `lance_qps` | 325.7 ops/s |
| `system/lance_vs_json/group_by` | `lance_qps` | 422 ops/s |
| `system/lance_vs_json/summary` | `lance_over_json` | 0.244 ratio |
| `system/json_streaming_ndjson/json_streaming` | `p95_ms` | 14.338 ms |
| `system/json_streaming_ndjson/json_streaming` | `rows_s` | 2.802e+05 ops/s |
| `system/json_streaming_ndjson/json_streaming` | `process_peak_rss_mib` | 45.398 MiB |
| `hyperfine/projection_pipeline` | `wall_median_seconds` | 5.45 s |
| `hyperfine/lance_vs_json` | `wall_median_seconds` | 39.995 s |

[Open the complete benchmark run](https://github.com/DeepLink-org/Persisting/actions/runs/34696478017).
