...
Latest nightly pChronicle benchmark: `870951dea9c8` on `linux/x86_64` (2026-09-11T02:18:51.491790+00:00).

| Case | Metric | Value |
|---|---:|---:|
| `criterion/atif_conversion/parse_corpus` | `latency_median_ns` | 5.502e+06 ns |
| `criterion/atif_conversion/roundtrip_corpus` | `latency_median_ns` | 7.426e+06 ns |
| `criterion/projection_cpu/events_to_storyline_corpus` | `latency_median_ns` | 3.29e+05 ns |
| `system/projection_pipeline/event_append` | `initial_append_ms` | 63.304 ms |
| `system/projection_pipeline/projection_build` | `build_ms` | 5245.731 ms |
| `system/projection_pipeline/projection_incremental` | `sync_ms` | 44.202 ms |
| `system/lance_vs_json/lifecycle` | `cold_query_ms` | 2911.551 ms |
| `system/lance_vs_json/lifecycle` | `get_storyline_full_ms` | 9.821 ms |
| `system/lance_vs_json/lifecycle` | `replace_storyline_ms` | 42.177 ms |
| `system/lance_vs_json/selective` | `lance_qps` | 334.1 ops/s |
| `system/lance_vs_json/group_by` | `lance_qps` | 463.3 ops/s |
| `system/lance_vs_json/summary` | `lance_over_json` | 0.244 ratio |
| `system/json_streaming_ndjson/json_streaming` | `p95_ms` | 13.467 ms |
| `system/json_streaming_ndjson/json_streaming` | `rows_s` | 3.016e+05 ops/s |
| `system/json_streaming_ndjson/json_streaming` | `process_peak_rss_mib` | 40.422 MiB |
| `hyperfine/projection_pipeline` | `wall_median_seconds` | 5.391 s |
| `hyperfine/lance_vs_json` | `wall_median_seconds` | 39.307 s |

[Open the complete benchmark run](https://github.com/DeepLink-org/Persisting/actions/runs/34554101281).
