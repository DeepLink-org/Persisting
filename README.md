...
Latest nightly pChronicle benchmark: `6d5bf4e394de` on `linux/x86_64` (2026-09-24T03:05:05.070419+00:00).

| Case | Metric | Value |
|---|---:|---:|
| `criterion/atif_conversion/parse_corpus` | `latency_median_ns` | 5.194e+06 ns |
| `criterion/atif_conversion/roundtrip_corpus` | `latency_median_ns` | 7.05e+06 ns |
| `criterion/projection_cpu/events_to_storyline_corpus` | `latency_median_ns` | 3.3e+05 ns |
| `system/projection_pipeline/event_append` | `initial_append_ms` | 70.01 ms |
| `system/projection_pipeline/projection_build` | `build_ms` | 5296.116 ms |
| `system/projection_pipeline/projection_incremental` | `sync_ms` | 42.654 ms |
| `system/lance_vs_json/lifecycle` | `cold_query_ms` | 3049.946 ms |
| `system/lance_vs_json/lifecycle` | `get_storyline_full_ms` | 10.27 ms |
| `system/lance_vs_json/lifecycle` | `replace_storyline_ms` | 45.595 ms |
| `system/lance_vs_json/selective` | `lance_qps` | 316.4 ops/s |
| `system/lance_vs_json/group_by` | `lance_qps` | 405.6 ops/s |
| `system/lance_vs_json/summary` | `lance_over_json` | 0.244 ratio |
| `system/json_streaming_ndjson/json_streaming` | `p95_ms` | 13.383 ms |
| `system/json_streaming_ndjson/json_streaming` | `rows_s` | 2.966e+05 ops/s |
| `system/json_streaming_ndjson/json_streaming` | `process_peak_rss_mib` | 47.855 MiB |
| `hyperfine/projection_pipeline` | `wall_median_seconds` | 5.503 s |
| `hyperfine/lance_vs_json` | `wall_median_seconds` | 40.817 s |

[Open the complete benchmark run](https://github.com/DeepLink-org/Persisting/actions/runs/35949922133).
