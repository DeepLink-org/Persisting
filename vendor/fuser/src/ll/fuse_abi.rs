...
#![allow(missing_docs)]
// This module intentionally mirrors the complete versioned kernel ABI. Some
// request structures are unavailable or unused on a particular host/feature
// combination but must remain defined for the other supported combinations.
#![allow(dead_code)]
